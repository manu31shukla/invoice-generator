    ...
    return (<Form onSubmit={this.openModal}>
      <Row>
        ...
        <Col md={4} lg={3}>
          ...
          <Link to='/'><Button variant="primary" type="submit" className="d-block w-100 my-2">All Invoices</Button></Link>
          <Button variant="primary" type="submit" className="d-block w-100 my-2">Save Invoice</Button>
